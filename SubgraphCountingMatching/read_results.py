...
## Non-dense (degree <= 3)
nondense_subgraphs = [subgraph for subgraph in subgraph_size_dict.keys() if subgraph_degree_dict[subgraph] <= 3]
# size <= 20
nondense_ss20 = [subgraph for subgraph in nondense_subgraphs if subgraph_size_dict[subgraph] <= 20]
# 20 < size <= 40
nondense_ss40 = [subgraph for subgraph in nondense_subgraphs if subgraph_size_dict[subgraph] > 20 and subgraph_size_dict[subgraph] <= 40]
# 40 < size <= 60
nondense_ss60 = [subgraph for subgraph in nondense_subgraphs if subgraph_size_dict[subgraph] > 40 and subgraph_size_dict[subgraph] <= 60]
# size > 60
...
results["Non-Dense Subgraphs"] = {
    ...
    "Size > 60": get_avg_runtime(nondense_ss60p, df["data"]["id"], df["time"]["avg"]),
}

## Dense (degree > 3)
dense_subgraphs = [subgraph for subgraph in subgraph_size_dict.keys() if subgraph_degree_dict[subgraph] > 3]
# size <= 20
dense_ss20 = [subgraph for subgraph in dense_subgraphs if subgraph_size_dict[subgraph] <= 20]
# 20 < size <= 40
dense_ss40 = [subgraph for subgraph in dense_subgraphs if subgraph_size_dict[subgraph] > 20 and subgraph_size_dict[subgraph] <= 40]
# 40 < size <= 60
dense_ss60 = [subgraph for subgraph in dense_subgraphs if subgraph_size_dict[subgraph] > 40 and subgraph_size_dict[subgraph] <= 60]
# size > 60
...
results["Dense Subgraphs"] = {
    ...
    "Size > 60": get_avg_runtime(dense_ss60p, df["data"]["id"], df["time"]["avg"]),
}
